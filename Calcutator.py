...
class Calculator:
    ...
    def __init__(self, root):
        ...
        self.MainFrame = Frame(self.root, bd = 18,width= 500, height= 670, relief= RIDGE, bg = "powder blue")
        self.MainFrame.grid()
        self.WidgetFrame = Frame(self.root, bd = 18,width= 490, height= 660, relief= RIDGE, bg = "cadet blue")
        self.WidgetFrame.grid()

        self.lblDisplay = Label(self.MainFrame, width=30, height=2, bg = "white" , font=('arial', 20, 'bold'), anchor='e')
